...
public class ViewInterCityBookedCab extends JFrame {
	...
	public ViewInterCityBookedCab(String username)  {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("cab/booking/system/icons/ambulance9.jpg"));
		...
		JLabel lblName = new JLabel("VIEW BOOKED AMBULANCE DETAILS");
		lblName.setFont(new Font("Yu Mincho", Font.PLAIN, 20));
		lblName.setBounds(88, 1, 350, 53);
		contentPane.add(lblName);
                
                JLabel lb3 = new JLabel("Patient Name :");
		...
		JLabel lblGender = new JLabel("AMBULANCE :");
